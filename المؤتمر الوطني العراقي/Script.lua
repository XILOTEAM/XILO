...
if check_time < 0 then return 'مجاني\n✓' end
...
local msgs = redis:get(max..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if rfih == 0 then  return "⇜ عذرا لا يوجد رسائل لك في البوت\n✗" end
...
if mtwren == 0 then  return "⇜ عذرا لا يوجد مطورين في البوت\n✗" end
...
sendMsg(msg.chat_id_,msg.id_,'⇜ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ذيلو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n✗')
end  
else
...
if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي🆔") and msg.type == "pv" then return  "\n⇜ ايديك هو : "..msg.sender_user_id_.."\n✓"  end

if MsgText[1]== "قناة السورس 📡" and msg.type == "pv" then
local inline = {{{text="⇜ قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/XILOTEAM"}}}
send_key(msg.sender_user_id_,'  [⇜ قناة سورس : ذيـلـو](t.me/XILOTEAM)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"⇜ للمطورين فقط\n✗" end
...
if not msg.SudoBase then return "⇜ للمطور فقط \n✗" end
...
if not msg.SudoBase then return "⇜ للمطور الاساسي فقط\n✗" end
local text = [[
ـــــــــــــــــــــــــــــــــــــ     
⇜ ❲اوامـر المطـور❳ 
⇜ تفعيـل ↭ ❲لتفعيل البوت ❳
...
return [[
⇜ اهلا بك في سورس ذيلو
ــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
⇜ [قناة السورس](t.me/XiLoTeAm)
⇜ [قناة شروحات السورس](t.me/InFoXiLo)
⇜ [بوت التواصل](t.me/TwSlXiLoBoT)
⇜ [مطور السورس](t.me/ZZEZD)
⇜ [تنصيب السورس](https://t.me/XiLoSource/12)
ــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
⇜ [بوت السورس الرسمي](https://XiL0BoT)
]]
end


if MsgText[1] == "التاريخ" then
return "⇜ الـتـاريـخ : "..os.date("%Y/%m/%d")
end
...
local rfih = (redis:get(max..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "⇜ عذرا لا يوجد سحكات لك في البوت\n✗" end
...
⇜ ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي الكروب تلقائين
...
⇜ اختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت⇜ ╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
elseif Text== "@ZZEZD" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/ZZEZD")
elseif Text== "Zed" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس ذيلو 😍](t.me/ZZEZD")
...
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"⇜ اسمي ["..Bot_Name.."]\n⇜ آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت\n⇜ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...\n⇜ ضيفني لكروبك ورفعني مشرف بلكروب وارسل تفعيل داخل الكروب")
...
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"⇜ اضغط علي الايدي ليتم نسخه\n\n "..USERNAME.." » ❲ `"..data.id_.."` ❳",37,USERCAR)  
return false
end)
...
⇜ بلتـوفيـق عزيزي ...
⇜ [اضغط هنا لديك مفاجئه](https://t.me/XILOTEAM)
]] )
--=====================================
