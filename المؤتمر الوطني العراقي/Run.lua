...
if msg.sender_user_id_ == 1331646237 then
msg.TheRankCmd = 'مطور السورس'
msg.TheRank = 'مطور ذيلو'
msg.Rank = 1
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/DEVXILO/XILO/master/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	if msg.text== ''..NameBot..' حدث ملفاتك' and msg.sender_user_id_ == SUDO_ID then
	...
	sendMsg(msg.chat_id_,msg.id_,'⇜ لقد حدثت ملفاتي\n✓',nil,function(arg,data)
	dofile("./inc/Run.lua")
